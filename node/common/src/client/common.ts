 ...
 * @export
 */
// Manual patch on generated code: explicit Promise<R> is required for TypeScript 5.9 declaration emit; re-apply after regeneration (see documentation/OpenAPI.md).
