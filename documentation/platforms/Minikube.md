...
In this guide we will show you how to install minikube and helm 3 as well as cert-manager, Gateway API + Envoy Gateway, and Keycloak. We will use existing installation methods for all of the Theia Cloud prerequisites.\
